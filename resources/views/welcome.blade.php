...
<main class="flex-grow">
    ...
    <div class="max-w-6xl mx-auto px-4 py-10">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
            ...
            <!-- CARD -->
            <div class="relative group bg-primary-100 rounded-lg shadow-md overflow-hidden max-w-xs mx-auto
                ...
                <div class="p-3">
                    ...
                    <p class="text-primary-400 text-xs mb-2 leading-snug">
                ...
                <div class="absolute inset-0 bg-black/70 flex items-center justify-center gap-3
                    ...
                    class="bg-primary-400 text-white px-3 py-1 text-sm rounded hover:bg-blue-600 transition">
                        Editar
                    </a>
...
document.querySelectorAll('.btn-delete').forEach(function(button) {
    button.addEventListener('click', function(e) {
        e.preventDefault(); // previne envio imediato do formulário
